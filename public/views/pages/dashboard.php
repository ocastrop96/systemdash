            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card card-gray">
                        ...
                        <div class="card-body">
                            <div class="chart rj1">
                                <canvas id="graphDash1" width="250" height="250"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="card card-info">
                        ...
                        <div class="card-body rj2">
                            <canvas id="graphDash2" width="250" height="250"></canvas>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6">
                    <div class="card card-success">
                        ...
                        <div class="card-body rj3">
                            <canvas id="graphDash3" width="250" height="250"></canvas>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="card card-teal">
                        <div class="card-header">
                            <h3 class="card-title font-weight-bold"> Atenciones por Médico</h3>
                        </div>
                        <div class="card-body">
                            <div class="chart rj4">
                                <canvas id="graphDash4" width="250" height="250"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
